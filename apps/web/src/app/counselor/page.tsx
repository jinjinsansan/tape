...
export default function CounselorsPage() {
  return (
    <div className="bg-gradient-to-b from-[#fff8f2] via-[#f8f3ff] to-[#fef8f3]">
      <main className="min-h-screen px-4 py-12 md:px-8">
        <div className="mx-auto max-w-5xl space-y-8">
          <header className="space-y-4 text-center">
            ...
            <p className="text-xs font-semibold tracking-[0.4em] text-[#92b4d6]">RESERVATION</p>
            <h1 className="text-3xl font-bold text-[#51433c]">カウンセリング予約</h1>
